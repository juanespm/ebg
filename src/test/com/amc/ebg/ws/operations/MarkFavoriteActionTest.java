 ...
 */
public class MarkFavoriteActionTest extends JPAUnitTest {

//    private MarkFavoriteAction action = new MarkFavoriteAction(getPersister());
...
//
//    @Test
//    public void testNewFavorite() {
//        IDList<Integer> result = action.execute(clientToken, 1, 2);
